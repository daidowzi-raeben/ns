            ...
            <div class="is-con">
                <div class="fl">
                    ...
                    <div id="question_tab_1" style="display: ;">
						...
						?>
                            <ul>
                                <li><p class="radio-box"><input type="radio" id="qa_answer_1_1" name="qa_answer_1" rel_q="1" value="1" class="noborder qa_answer_19"><label for="qa_answer_1_1">1.<?php echo $ex[0]?> </label></p></li>
                                <li><p class="radio-box"><input type="radio" id="qa_answer_1_2" name="qa_answer_1" rel_q="1" value="2" class="noborder qa_answer_19"><label for="qa_answer_1_2">2.<?php echo $ex[1]?></label></p></li>
                                <li><p class="radio-box"><input type="radio" id="qa_answer_1_3" name="qa_answer_1" rel_q="1" value="3" class="noborder qa_answer_19"><label for="qa_answer_1_3">3.<?php echo $ex[2]?></label></p></li>
                                <li><p class="radio-box"><input type="radio" id="qa_answer_1_4" name="qa_answer_1" rel_q="1" value="4" class="noborder qa_answer_19"><label for="qa_answer_1_4">4.<?php echo $ex[3]?></label></p></li>
                            </ul>
                        </div>
                    </div>
                    <div class="ctrl"><a name="#qq_20">
                        </a><a href="./quiz.php?no=<?php echo $no-1?>" id="btn_prev" class="prev"><span>이전</span></a>
                        <a href="./quiz.php?no=<?php echo $no+1?>" id="btn_next" class="next"><span>다음</span></a>
                    </div>
                    <script>
                        view_question(1);
                    </script>
