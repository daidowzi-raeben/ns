...
<head>
    ...
    <title>NS홈쇼핑</title>
    <link type="text/css" rel="stylesheet" media="all" href=" ../_Css/common.css?v=<?php echo date("his")?>" />
    <link type="text/css" rel="stylesheet" media="all" href=" ../_Css/styleDefault.css?v=<?php echo date("his")?>" />
    <link type="text/css" rel="stylesheet" media="all" href=" ../_Css/layout.css?v=<?php echo date("his")?>" />
    <link type="text/css" rel="stylesheet" media="all" href=" ../_Css/content.css?v=<?php echo date("his")?>" />
</head>
