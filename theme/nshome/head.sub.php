...
?>
<link type="text/css" rel="stylesheet" media="all" href="<?php echo G5_URL ?>/_Css/common.css?ver=<?php echo G5_CSS_VER; ?>" />
...
<link type="text/css" rel="stylesheet" media="all" href="<?php echo G5_URL ?>/_Css/content.css?ver=1<?php echo G5_CSS_VER; ?>" />
...
<script  type="text/javascript" src="<?php echo G5_URL ?>/_Js/sub.js"></script>
</head>
<body id="sub">
<div id="skipNavi">
