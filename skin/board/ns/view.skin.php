...
<div class="content-ov">
    <div id="subNavi-wrap">
        <div id="subNavi">
            ...
            <div class="leftmenu" id="leftmenu">
                <ul class="depth2">
                    <li id="lm01" class='lm_l2<?php echo $over1?>'><a
                            href="<?php echo G5_URL?>/bbs/board.php?bo_table=notice" class='lm_a2'><span
                                class='isTxt'>공지사항</span></a></li>
                    <li id="lm02" class='lm_l2'><a href="<?php echo G5_URL?>/Community/community02.php"
                            class='lm_a2'><span class='isTxt'>헬프라인</span></a></li>
                    <li id="lm03" class='lm_l2<?php echo $over2?>'><a
                            href="<?php echo G5_URL?>/bbs/board.php?bo_table=data" class='lm_a2'><span
                                class='isTxt'>자료실</span></a></li>
                    <li id="lm04" class='lm_l2<?php echo $over3?>'><a
                            href="<?php echo G5_URL?>/bbs/board.php?bo_table=cns" class='lm_a2'><span
                                class='isTxt'>준법상담</span></a></li>
                </ul>
            </div>
        </div>
    ...
    <div id="contents">
        ...
        <div class="board-view-wrap">
                ...
                <thead>
                    <tr>
                        <th>
                            ...
                            <span><strong>작성일자</strong> :
                                <?php echo date("y-m-d H:i", strtotime($view['wr_datetime'])) ?></span>
                    ...
                    <tr>
                        <td>
                            ...
                            <a href="<?php echo $view['file'][$i]['href'];  ?>"
                                class="file-add"><span><?php echo $view['file'][$i]['source'] ?></span></a>
                        </td>
                    </tr>
                    <?php
							}
            ...
            <div>
                <?php 
    if($bo_table == 'ns_co' || $bo_table == 'guide' || $bo_table == 'info'|| $bo_table == 'cns') {
        ?>
                <div id="contents" style="min-height:unset !important;">
                    <div class="confirm">
                        <a href="javascript:confirmProc()">확인</a><span>페이지 다 읽으신 후 <strong>확인버튼</strong>을 클릭해 주시면 나의
                            마일리지에 반영됩니다.</span>
                    </div>
                </div>
                <?php } ?>
