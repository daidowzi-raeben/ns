...
var mobileScale = 1; //¸ğ¹ÙÀÏ¿¡¼­ »çÀÌÁî º¯È­¿¡ µû¸¥ ½ºÄÉÀÏ °ª ÀúÀå
...
$(document).ready(function () {
  ...
  //Æú´õÀÇ Â÷½Ã¿Í ¼¼ÆÃµÈ Â÷½Ã°¡ µ¿ÀÏÇÑÁö ºñ±³ÇØ¼­ ´Ù¸£¸é Ã¢´İ±â
  ...
  //////////////////////////////////////////////////////////////////////////////////////
  //ºñµğ¿ÀÀÇ Àç»ıÀ¯¹«¿¡ µû¶ó Àç»ı/ÀÏ½ÃÁ¤Áö ¹öÆ°ÀÌ ÀÚµ¿À¸·Î ¹Ù²îµµ·Ï ¼¼ÆÃ
  ...
  //ºñµğ¿À°¡ ·ÎµåµÇ¾î¾ß¸¸ ½ºÅµ ¹öÆ°ÀÌ º¸ÀÌµµ·Ï timeupdate·Î ÁÜ
  $("#video").on("timeupdate", function () {
  ...
  //ºñµğ¿À°¡ ³¡³ªÁö ¾ÊÀº °æ¿ì¿¡´Â ´ÙÀ½ÆäÀÌÁö ¸»Ç³¼±ÀÌ ¾Èº¸ÀÌµµ·Ï ÇÔ
  $("#video").on("ended", function () {
    if (pageType == "video") {
      showBalloon();
  ...
  //ºñµğ¿À°¡ ·ÎµåµÇ¾î¾ß¸¸ ºÏ¸¶Å© ¹öÆ°ÀÌ º¸ÀÌµµ·Ï timeupdate·Î ÁÜ
  $("#video").one("timeupdate", function () { //ÇÑ¹ø¸¸ ½ÇÇàµÇµµ·Ï one »ç¿ë
    $("#bookMark").fadeIn(500);
  });
  //ºñµğ¿ÀÀÇ ½Ã°£¿¡ µû¶ó ºÏ¸¶Å© »ö»óÀÌ º¯ÇÏµµ·Ï timeupdate·Î ÁÜ
  $("#video").on("timeupdate", function () {
  ...
  //ºñµğ¿ÀÆË¾÷ ¹öÆ° ½Ã°£¿¡ µû¶ó º¸¿©Áö°í ºñµğ¿À Á¤Áö
  ...
  //Åõ¸íµµ Á¶Àı ÀÌ¹ÌÁö ¹öÆ° ½Ã°£¿¡ µû¶ó º¸¿©Áü/¾Èº¸¿©Áü
  $("#video").on("timeupdate", function () {
  ...
  //Åõ¸íµµ Á¶Àı ÀÌ¹ÌÁö ¹öÆ° ¸¶¿ì½º ¾Æ¿ô/¿À¹ö
  ...
  //Åõ¸íµµ Á¶Àı ÀÌ¹ÌÁö ¹öÆ°À» Å¬¸¯ÇßÀ» ¶§
  var opacityPopupShow = false; ///Åõ¸íµµ Á¶Àı ÀÌ¹ÌÁö°¡ º¸ÀÌ´Â »óÅÂÀÎÁö ÀúÀåÇÒ º¯¼ö
  ...
  //Åõ¸íµµ Á¶Àı ÀÌ¹ÌÁö ³Ø¹é ¹öÆ° Å¬¸¯ÇßÀ» ¶§
  ...
  //½Ç½Ã°£ ÀÚ¸·À» »ç¿ëÇÒ °æ¿ì ºñµğ¿À ½Ã°£¿¡ µû¸¥ ÀÚ¸· ÅØ½ºÆ® º¯°æ
  $("#video").on("timeupdate", function () {
  ...
  $("#script").on("click", function () {
    if (realTimeScriptUse == false) { //½Ç½Ã°£ ÀÚ¸·À» »ç¿ëÇÏÁö ¾ÊÀ» °æ¿ì
      ...
      if (locationCenter == true) {
        //ÀÚ¸· ¾Ö´Ï¸ŞÀÌ¼Ç È¿°ú
        if ($("realTimeScriptLayer").css("bottom") == "-50px") { //¾Ö´Ï¸ŞÀÌ¼Ç È¿°ú¸¦ ÁÖ±âÀ§ÇØ controller.cssÀÇ scriptLayer{} ¿¡¼­ bottom°ª ÁØ¸¸Å­ Àû¾îÁÜ
          scriptShow = true;
          ...
          scriptShow = false;
          $("realTimeScriptLayer").stop().animate({ bottom: "-50px" }, 600, function () { //¾Ö´Ï¸ŞÀÌ¼Ç È¿°ú¸¦ ÁÖ±âÀ§ÇØ controller.cssÀÇ scriptLayer{} ¿¡¼­ bottom°ª ÁØ¸¸Å­ Àû¾îÁÜ
  ...
  $("#index , #indexIcon").on("click", function () {
    ...
    */
    //ÀÎµ¦½º ¾Ö´Ï¸ŞÀÌ¼Ç È¿°ú
    if ($("#indexLayer").css("left") == "-240px") { //¾Ö´Ï¸ŞÀÌ¼Ç È¿°ú¸¦ ÁÖ±âÀ§ÇØ controller.cssÀÇ index > #indexLayer{} ¿¡¼­ left°ª ÁØ¸¸Å­ Àû¾îÁÜ
      $("#indexLayer").show();
      ...
      $("#indexLayer").stop().animate({ left: "-240px" }, 600, function () { //¾Ö´Ï¸ŞÀÌ¼Ç È¿°ú¸¦ ÁÖ±âÀ§ÇØ controller.cssÀÇ index > #indexLayer{} ¿¡¼­ left°ª ÁØ¸¸Å­ Àû¾îÁÜ
        $("#indexLayer").hide();
      });
    }
  });
  ...
  //·¯´×¸Ê ÆË¾÷Ã¢ÀÌ ÀÖ°í ¾ø°í¿¡ µû¶ó setIntervalÀ» ÀÌ¿ëÇÑ ºñµğ¿À Àç»ı ÄÁÆ®·Ñ
  ...
  //¼Óµµ ¹öÆ°À» Å¬¸¯ÇßÀ» ¶§ º¯°æÇÒ ¼Óµµ ¸ñ·Ï ¿­°í ´İÀ½
  ...
  $("footer > div > .videoRateList").on("click", function (e) {
    ...
    video.defaultPlaybackRate = video.playbackRate; //IE¿¡¼­ ÀÏ½ÃÁ¤Áö¿¡¼­ Àç»ı»óÅÂ·Î ¹Ù²ğ¶§ Àç»ı¼Óµµ °ªÀÌ ÃÊ±âÈ­µÇ´Â ¹®Á¦ ÇØ°á
  ...
  /******************************************************************/
  //currentTimeÀº ºñµğ¿ÀÀÇ ÇöÀç Àç»ı °ªÀ» ¹İÈ¯ÇÏ°Å³ª °ªÀ» ¼³Á¤ÇÒ¼ö ÀÖ´Ù
  //durationÀº ºñµğ¿À ½Ã°£ °ªÀ» ¹İÈ¯

  //Àç»ı¹ÙÀÇ À§Ä¡¸¦ º¯°æÇßÀ»¶§ ¿µ»ó Àç»ı À§Ä¡ º¯°æ
  $("#progressBarArea").on("mousedown", function (e) {
  // µå·¡±× Àç»ı¹Ù Àá±İ ½ÃÀÛ(¾È Àá±Û¶§´Â ÀÌºÎºĞ »èÁ¦)
	if (pageType == "video") {
      return;
    } 
  // µå·¡±× Àç»ı¹Ù Àá±İ ³¡(¾È Àá±Û¶§´Â ÀÌºÎºĞ »èÁ¦)
    var getId = e.target.getAttribute("id");
    ...
    if (getId.indexOf("progressBookMarkPoint") == -1) {
      ...
      $("body").on("mouseup", function (e) { //Àç»ı¹Ù Á¶ÀıÁß¿¡ ¿µ¿ª¹Û¿¡¼­ ¸¶¿ì½º Å¬¸¯À» ¶§°í ´Ù½Ã ¿µ¿ª¾ÈÀ¸·Î µé¾î¿À¸é ¸¶¿ì½º ¿òÁ÷ÀÌ´Â´ë·Î Á¶ÀıÀÌ ¿òÁ÷ÀÌ´Â °ÍÀ» ¹æÁöÇÏ±â À§ÇØ mousemove¸¦ ÇØÁ¦
        $("#progressBarArea").off("mousemove");
      });
    }
  });
  //¿µ»óÀÌ Àç»ıµÇ´Â Á¤µµ¿¡ µû¶ó Àç»ı¹Ù ¿òÁ÷ÀÓ
  $("#video").on("timeupdate", function () {
  ...
  //Àç»ı¹Ù¸¦ ¿òÁ÷ÀÌ°í ÀÖÀ»¶§ ¿µ»óÀÌ °è¼Ó Àç»ıµÇ°í ÀÖÀ¸¹Ç·Î ¸¶¿ì½º Å¬¸¯ÁßÀÏ¶§ ºñµğ¿À¸¦ ¸ØÃã
  $("#progressBarArea").on("mousedown", function () {
    video.pause();
  });
  //¸¶¿ì½º Å¬¸¯ÀÌ ³¡³ª¸é ºñµğ¿À ´Ù½Ã Àç»ı
  ...
  //À½¼Ò°Å ¹öÆ° Å¬¸¯ÇßÀ» ¶§
  //volume °ªÀº 0.0 ~ 1.0 »çÀÌÀÇ °ª¸¸ »ç¿ë°¡´ÉÇÏ¹Ç·Î ÁÖÀÇ(100À» °öÇØÁà¼­ °ªÀÇ ¹üÀ§¸¦ ³ĞÈû)
  var volumeSave; //À½¼Ò°Å ÀüÀÇ º¼·ı °ªÀ» ÀúÀåÇÒ º¯¼ö
  ...
  //À½·®Á¶Àı ¿µ¿ªÀ» Å¬¸¯ÇßÀ»¶§ º¼·ıÀÇ °ªÀ» ºñµğ¿À º¼·ı¿¡ ÀúÀå
  $("#volumeBarArea").on("mousedown", function (e) { //¸¶¿ì½º¸¦ Å¬¸¯ÇÑÃ¤·Î º¼·ı Á¶Àı½Ã Á¶ÀıÇÏ´ÂÁ¤µµ°¡ º¸ÀÌµµ·Ï mousedown¾È¿¡ mousemove¸¦ ÁÜ
    var relativeX = (e.pageX - $(this).offset().left);
    var EventWidth = $(this).width() * getScale;
    ...
    $("body").on("mouseup", function (e) { //º¼·ı Á¶ÀıÁß¿¡ ¿µ¿ª¹Û¿¡¼­ ¸¶¿ì½º Å¬¸¯À» ¶§°í ´Ù½Ã ¿µ¿ª¾ÈÀ¸·Î µé¾î¿À¸é ¸¶¿ì½º ¿òÁ÷ÀÌ´Â´ë·Î Á¶ÀıÀÌ ¿òÁ÷ÀÌ´Â °ÍÀ» ¹æÁöÇÏ±â À§ÇØ mousemove¸¦ ÇØÁ¦
  ...
  //´ÙÀ½ ¹öÆ° Àá±İ ½ÃÀÛ(Àá±İ Ç®¶§´Â ÀÌ ÄÚµå »èÁ¦)
     if (pageType == "video" && !video.ended) {
      return;
    }
  // [¼öÁ¤] ÄûÁî ÆäÀÌÁö´Â ÄûÁî ¿Ï·á Àü(next Àá±İ) ÀÌµ¿ ±İÁö
    if (pageType == "quiz" && (typeof quizSolved === "undefined" || quizSolved !== true)) {
      return;
    }
  //´ÙÀ½ ¹öÆ° Àá±İ ³¡(Àá±İ Ç®¶§´Â ÀÌ ÄÚµå »èÁ¦)	  
    var page = Number(currentPageNum) + 1;
  ...
  //Utils.jsÀÇ zerofillÇÔ¼ö¸¦ ÀÌ¿ëÇØ¼­ ÀÏÀÇ ÀÚ¸®¼ö¿¡ 0À» ºÙ¿© 10ÀÇ ÀÚ¸®¼ö·Î Ç¥ÇöÇÏ°í ÃÊ·Î ³ª¿À´Â ½Ã°£À» ½ÃºĞÃÊ·Î ¹Ù²î°Ô ÇÔ

  //ºñµğ¿ÀÀÇ ÇöÀç Àç»ı½Ã°£À» º¸¿©ÁÜ
  $("#video").on("timeupdate", function () {
    if ($("#playTime").length) { //ÇØ´ç id°ªÀÌ Á¸Àç ÇØ¸é ½ÇÇà
      playTime.innerHTML = videoTime(video.currentTime);
    }
  });
  //ºñµğ¿ÀÀÇ ÃÑ Àç»ı½Ã°£À» º¸¿©ÁÜ
  $("#video").on("loadedmetadata timeupdate", function () { //¸ŞÅ¸µ¥ÀÌÅÍ°¡ ·ÎµåµÇ¸é ½Ã°£ÀÌ ¹Ù·Î ³ªÅ¸³ª°Ô loadedmetadata¸¦ »ç¿ëÇßÁö¸¸ ÆÄÀÌ¾îÆø½º¿¡¼­´Â »ç¿ëÇÒ ¼ö ¾ø¾î¼­ timeupdateµµ °°ÀÌ »ç¿ë
  ...
  $(document).on("keydown", function (e) {
    ...
    else {//IE¿¡¼­ ½ºÆäÀÌ½º¹Ù, ¹æÇâÅ°°¡ ¾Ë¾Æ¼­ ¸ÔÇô¼­ ºñµğ¿À¸¦ Á¦¾î ÇÏ´Â°É ¸·À½
      if (pageType != "write") {
        //¿£ÅÍ
        if (e.keyCode == 13) { return false; }
        //½ºÆäÀÌ½º
