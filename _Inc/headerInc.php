<div class="quick">
  <!-- <ul>
    ...
    <?php
	$sql = " select count(srvd_no) as cnt from {$g5['survey_data_table']} where srvy_code = '19' and srvd_uid = '{$member['mb_id']}' and srvy_year = '{$result['srvy_year']}' ";
	$res = sql_fetch($sql);
  ...
  <?php } ?>
      ...
      <?php
	$sql = " select count(srvd_no) as cnt from {$g5['survey_data_table']} where srvy_code = '21' and srvd_uid = '{$member['mb_id']}' ";
	$res = sql_fetch($sql);
            ...
            <div class="depth2-wrap subg">
              <div class='depth2'>
                ...
                <div>
                  ...
                  <div id="tm0404" class="mn_l2"><a href="<?php echo G5_URL ?>/bbs/board.php?bo_table=e_story" class="mn_a2" target="_self"><span class="txt">윤리이야기</span></a></div>
                </div>
