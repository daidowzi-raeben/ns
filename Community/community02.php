...
?>
    ...
    <div class="content-ov">
      ...
      <div id="contents">
        ...
        <p style="text-align:center; padding:10px 0"><span style="padding-right:5px"><a href="https://www.kbei.org/whistle/center/?code=harimholdings" target="_blank"><img src="../_Img/Sub/community/btn_report.gif" alt="헬프라인 신고하기" width="213" height="43"></a></span><span><a href="https://www.kbei.org/whistle/center/?code=harimholdings" target="_blank"><img src="../_Img/Sub/community/btn_question.gif" alt="윤리경영 질의하기" width="213" height="43"></a></span></p>
...
※ 처리결과는 <span style="font-weight:bold">케이휘슬 홈페이지(https://www.kbei.org/whistle 접속 → 메인화면→처리결과확인)</span>에서 확인하실 수 있습니다.
</p>
