...
$sql_where = " where ap.app_uid = '{$member['mb_id']}' and ap.app_lssn_no = '5' ";
...
<script src="/js/lms.js"></script>
    ...
    <div class="content-ov">
        ...
        <div id="contents">
            ...
            <!-- page-start // -->
			<?php
			$userLessonData = get_lessonApply2($member['mb_id'], 5);
			?>
			...
			<div class="progress-wrap">
                ...
                <table class="tbl-type01">
                    ...
                    <tbody>
					<?php
					$sql = "select * from {$g5['chapter_table']} where cpt_lesson='5' order by cpt_seq asc";
                    ...
                    <tr>
						...
						?>
							<a href="#" class="cg-btn active"><span class="enterClass2" lno="2" cno="<?php echo $row['cpt_no']?>">학습하기</span></a>
						<?php
						} ?>
                        </td>
                    </tr>
