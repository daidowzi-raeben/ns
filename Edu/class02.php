...
$sql_where = " where ap.app_uid = '{$member['mb_id']}' and ap.app_lssn_no = '1' ";
...
<script src="/js/lms.js"></script>
    ...
    <div class="content-ov">
        ...
        <div id="contents">
            ...
            <!-- page-start // -->
			<?php
			$userLessonData = get_lessonApply($member['mb_id']);
			?>
			...
			<div class="progress-wrap">
                ...
                <table class="tbl-type01">
                    ...
                    <tbody>
					<?php
					$sql = "select * from {$g5['chapter_table']} where cpt_lesson='1' order by cpt_seq asc";
					$cpt_data = sql_query($sql);
					
					for ($i=0; $row=sql_fetch_array($cpt_data); $i++) {
                    ...
                    <tr>
						...
						?>
							<a href="#" onclick="$('.new__pop').show();" class="cg-btn"><span class="enterClass2" lno="1" cno="<?php echo $row['cpt_no']?>">학습완료</span></a>
						<?php
						} elseif( $cpt_study_rate[$i-1] >= 100 || $i == 0 ) {
						?>
							<a href="#" class="cg-btn active"><span class="enterClass2" lno="1" cno="<?php echo $row['cpt_no']?>">학습하기</span></a>
						<?php
						} ?>
                        </td>
                    </tr>
