<?php
# ====== [2022 상반기 전사 CP교육(2)] 대규모유통업법에 대한 이해 / 교육 페이지 ===========
			...
			<div class="progress-wrap">
                ...
                <div class="btn-wrap r">
                    ...
                    <div class="btn_area">
						...
						?>
						<a href="#" onclick="window.open('/Edu/pop13.php', '_blank', 'top=0,left=0,width=1050,height=750')" class="class-regist "><span>응시하기</span></a>
						<?php
						}
						?>
                    </div>
