...
add_javascript('<script type="text/javascript" src="'.G5_URL.'/js/jquery.bpopup.min.js"></script>', 0);
?>
<script>
	...
	<input type="hidden" name="lno" value="<?php echo $lno ?>">
        <table>
            ...
            <tr>
                ...
                <td colspan="3">
                    <input type="text" class="new__input width_400" name="lssn_title" id="lssn_title" value="<?php echo $lssn['lssn_title'] ?>" <?php echo $required_mb_id ?>  />
                </td>
            </tr>
			<tr>
