...
<div id="bo_list" style="width:<?php echo $width; ?>">
    ...
    <div class="tbl_head01 tbl_wrap">
        <table>
        <caption><?php echo $board['bo_subject'] ?> 목록222</caption>
        <thead>
		<tr>
		...
		<tr class="<?php echo $bg; ?>">
			...
			<td headers="cp_list_">준법퀴즈1</td>
			<td headers="cp_list_">학습기간</td>
			<td headers="cp_list_">활성유무</td>
			<td headers="cp_list_" class="td_mng td_mng_s" rowspan="2"><?php echo $s_mod ?></td>
		</tr>
		<tr class="<?php echo $bg; ?>">
			<td headers="cp_list_">파일위치</td>
			<td headers="cp_list_" colspan="2"></td>
			<td headers="cp_list_">찾아연결</td>
		</tr>
