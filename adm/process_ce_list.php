...
<div class="tbl_frm02 tbl_wrap">
	...
	<tr>
		...
		<td colspan="3">
			<select>
				<option value="">e-윤리영상 캠페인</option>
			</select>
		</td>
	</tr>
	</tbody>
...
<div class="tbl_head01 tbl_wrap">
    ...
    for ($i=0; $row=sql_fetch_array($result); $i++) {
        ...
        if ($is_admin == 'group') {
            ...
            $s_mod = '<a href="./process_ce_form.php?'.$qstr.'&amp;w=u&amp;pc_no='.$row['pc_no'].'" class="btn btn_03">수정</a>';
        }
	...
	<tr class="<?php echo $bg; ?>">
		...
		<td headers="cp_list_" colspan="2">process/ethics/<?php echo $p_url?></td>
