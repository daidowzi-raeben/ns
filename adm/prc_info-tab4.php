...
<div>
    ...
    <a href="prc_info-tab2.php" class="btn btn_02">수강생</a>
    <a href="prc_info-tab3.php" class="btn btn_02">진도관리</a>
    <a href="prc_info-tab4.php" class="btn btn_03">시험관리</a>
</div>
    ...
    <div class="local_ov02">
        ...
        <div class="r_div">
            <?php if ($is_admin == 'super') { ?>
                ...
                <a href="./" id="member_add" class="btn btn_03">엑셀다운로드</a>
    ...
    <div class="tbl_head01 tbl_wrap">
        <table>
            ...
            <tr>
                ...
                <th scope="col" id="cp_list_no">시험 문항수</th>
                <th scope="col" id="cp_list_no">시작일 시험</th>
                <th scope="col" id="cp_list_no">종료일 시험</th>
                <th scope="col" id="cp_list_no">취득 점수</th>
            ...
            for ($i=0; $i<10; $i++) { ?>
                <tr class="<?php echo $bg; ?>">
                    ...
                    <td headers="cp_list_"  >10</td>
                    <td headers="cp_list_"  >2019-10-25</td>
                    <td headers="cp_list_"  >2019-10-25</td>
                    <td headers="cp_list_"  >60점</td>
