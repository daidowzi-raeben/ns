...
$sql_common = " from {$g5['belong_table']} ";
	...
	<tr>
		...
		<td colspan="3">
			...
			<select name="sfl" id="sfl">
				<option value="bl_name"<?php echo get_selected($_GET['sfl'], "bl_name"); ?>>회사명</option>
...
<div class="local_ov02">
	...
	<div class="r_div">
		...
		<a href="./belong_form.php" id="member_add" class="btn btn_03">소속등록</a>
		<?php } ?>
	</div>
</div>
...
<div class="tbl_head01 tbl_wrap">
    ...
    <tr>
		...
		<th scope="col" id="mb_list_name">소속코드</a></th>
