...
else if ($w == 'u')
{
	...
	$mb['mb_1'] == "C" ? $mb_1_c = "checked" : $mb_1_n = "checked";
}
else
...
<div class="tbl_frm01 tbl_wrap">
	...
	<tr>
		...
		<th scope="row"><label for="mb_1">유형</label></th>
        <td>
	...
	<tr>
        ...
        <th scope="row"><label for="mb_password">비밀번호(사번)<?php echo $sound_only ?></label></th>
	...
	<tr>
        ...
        <td>
			<input type="text" name="mb_2" value="<?php echo $mb['mb_2'] ?>" id="mb_2" class="frm_input" size="30" maxlength="20">
		</td>
    ...
    <tr>
        ...
        <td><input type="text" name="mb_name" value="<?php echo $mb['mb_name'] ?>" id="mb_name" class="frm_input" size="30"  maxlength="20"></td>
