...
<div class="local_ov02">
	...
	<div class="r_div">
		...
		<a href="./proc_es_excel_down.php?sfl=<?php echo $sfl ?>&amp;str=1&amp;bl_year=<?php echo $bl_year?>&amp;bl_cate=<?php echo $bl_cate?>" target="_blank" id="member_add" class="btn btn_04">EXCEL</a>
		<?php } ?>
	</div>
</div>
...
<div class="tbl_head01 tbl_wrap">
    ...
    <tr class="<?php echo $bg; ?>">
		...
		for($j=1; $j<=$proc_count; $j++) {
			$chkView = check_point_NS($row['mb_id'], 'e_story', '@'.$j, $bl_year, $bl_cate);
		?>
