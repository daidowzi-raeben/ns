...
<div>
    ...
    <a href="prc_info-tab3.php" class="btn btn_03">진도관리</a>
    ...
    <div class="tbl_head01 tbl_wrap">
        <table>
            ...
            <tr>
                ...
                <th scope="col" id="cp_list_no">학습 진도율</th>
                <th scope="col" id="cp_list_no">시험 취득 점수</th>
            ...
            for ($i=0; $i<10; $i++) { ?>
                <tr class="<?php echo $bg; ?>">
                    ...
                    <td headers="cp_list_"  >100%</td>
                    <td headers="cp_list_"  >60점</td>
                    <td headers="cp_list_"  >수료
                    </td>
                </tr>
                <?php
            } ?>
