...
<div class="tbl_frm02 tbl_wrap">
    ...
    <form action="./rslt_reg_update.php" enctype="multipart/form-data" method="post" name="qqform" id="qqform" onsubmit="return qcheck(this)">
        <table>
            <colgroup>
                <col class="grid_4">
                <col>
            ...
            <tr>
                ...
                <td>
                    <input type="text" name="quiz_name" class="new__input w100" <?php echo $required_rslt ?> />
                </td>
            </tr>
