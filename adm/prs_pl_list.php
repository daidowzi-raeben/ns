...
<input type="hidden" name="pld_year" value="<?php echo $bl_year ?>">
<input type="hidden" name="pld_semi" value="<?php echo $bl_cate ?>">
...
<div class="local_ov02">
	...
	<div class="r_div">
		...
		<a href="./pldexcel_down.php?pld_year=<?php echo $bl_year ?>&amp;pld_semi=<?php echo $bl_cate ?>&amp;sfl=<?php echo $sfl ?>&amp;str=1" target="_blank" id="member_add" class="btn btn_04">EXCEL</a>
		<?php } ?>
	</div>
</div>
...
<div class="tbl_head01 tbl_wrap">
    ...
    for ($i=0; $row=sql_fetch_array($result); $i++) {
		...
		$sql2 = " select * from sj_prs_pledge where mb_id = '{$row['mb_id']}' and pld_flag = '2' and pld_year='$bl_year' and pld_semi='$bl_cate' limit 0, 1 ";
		$row2 = sql_fetch($sql2);
