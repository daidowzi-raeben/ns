...
<div class="local_ov02">
	...
	<div class="r_div">
		...
		<a href="./proc_ce_excel_down.php?sfl=<?php echo $sfl ?>&amp;str=1&amp;bl_year=<?php echo $bl_year?>&amp;bl_cate=<?php echo $bl_cate?>" target="_blank" id="member_add" class="btn btn_04">EXCEL</a>
		<?php } ?>
	</div>
</div>
...
<div class="tbl_head01 tbl_wrap">
    ...
    <tr>
		...
		<th scope="col" id="mb_list_name" colspan="<?php echo $proc_count?>">e-윤리영상켐페인 수행결과</th>
