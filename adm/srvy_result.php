...
<div class="local_ov02">
    <div class="l_div">
        <a href="#" class="btn btn_03"><?php echo $btnTitle ?> 진도관리</a>
        <a href="srvy_result2.php?type=<?php echo $type . $NSqstr?>" class="btn btn_02"><?php echo $btnTitle ?>
            설문데이터</a>
    </div>
    <div class="r_div">
        <?php if ($is_admin == 'super' || $is_admin == 'manager') { ?>
        <a href="./srvy_excel_down.php?type=<?php echo $type . $NSqstr?>&amp;str=1" target="_blank" id="member_add"
