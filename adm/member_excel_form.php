...
<form name="fmember" id="fmember" action="./member_excel_form_update.php" onsubmit="return fmember_submit(this);" method="post" enctype="multipart/form-data">
...
<div class="tbl_frm01 tbl_wrap">
	...
	<tr>
        ...
        <td>
			...
			~
            <input type="text" name="mb_9" value="<?php echo $mb_8 ?>" id="mb_9" class="required frm_input" />
		</td>
    </tr>
	</tbody>
    </table>
...
<div class="btn_fixed_top">
	<a href="./file/memberexcel_form.xls" target="_blank" id="sample_down" class="btn btn_04">샘플양식다운로드</a>
