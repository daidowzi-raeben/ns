...
$sql = " select count(*) as cnt from {$g5['compliance_table']} ";
$row = sql_fetch($sql);
$proc_count = $row['cnt'];
...
<div class="local_ov02">
	...
	<div class="r_div">
		...
		<a href="./proc_cp_excel_down.php?sfl=<?php echo $sfl ?>&amp;str=1&amp;bl_year=<?php echo $bl_year?>&amp;bl_cate=<?php echo $bl_cate?>" target="_blank" id="member_add" class="btn btn_04">EXCEL</a>
		<?php } ?>
	</div>
</div>
...
<div class="tbl_head01 tbl_wrap">
    ...
    <tr>
		...
		<th scope="col" id="mb_list_name" colspan="<?php echo $proc_count?>">e-준법퀴즈캠페인 수행결과</th>
	...
	<?php
	for($i=1; $i<=$proc_count; $i++) {
		$chkView = check_point_NS($row['mb_id'], 'p_comp', '@'.$i, $bl_year, $bl_cate);
	?>
