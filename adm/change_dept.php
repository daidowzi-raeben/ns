...
<form name="fmember" id="fmember" action="./change_dept_update.php" onsubmit="return fmember_submit(this);" method="post" enctype="multipart/form-data">
...
<div class="tbl_frm01 tbl_wrap">
	...
	<tr>
		<td colspan="4">
			<label for="comment">
				1. 샘플양식을 다운로드 받아 작성한 후 업로드 하십시오.</br>
				2. 업로드 된 회원 정보를 확인한 후 등록하기 버튼을 클릭하면 등록이 완료 됩니다.
			</label>
		</td>
	</tr>
	<tr>
