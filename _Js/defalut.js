...
$(document).ready(function(){	 
   // input & select
	$('.tc-input').find('input[type=text]').css({'color':'#999'});
	$('.tc-input').find('input[type=text]').change(function() {
	...
	$('.tc-input.active').find('input[type=text]').css({'color':'#212121'});
	$('.tc-input.active').find('input[type=text]').change(function() {
	...
	if($(".layer-slider-ovclick").length<1) $("<div class='layer-slider-ovclick'/>").appendTo($("#contents")).hide();
	$('.mn-allbtn').click(function(){
		$('.allmenu-wrap').show();
		 ovShow()
	});
	
	$('.allmenu-wrap').find('.close').click(function(){
		ovHide();
	});
